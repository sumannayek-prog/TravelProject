...
const userReadmorePack = require('./router/user/packages.readMore')
server.use(userReadmorePack)
const userReadmoreBlog = require('./router/user/blogs.readMore')
server.use(userReadmoreBlog)
const userReadmoreAbout = require('./router/user/about.readMore')
server.use(userReadmoreAbout)
